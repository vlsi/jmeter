            ...
            doLast {
                ...
                for (dep in allDependencies) {
                    ...
                    workerExecutor.submit(CalculateSHA512::class.java) {
                        ...
                        params(dep.value, verification.hashes[dep.key] ?: "")
                    }
                }
...
class CalculateSHA512 @Inject constructor(
    ...
    override fun run() {
        ...
        if (expectedHash.isBlank()) {
            throw HashMissingException(file, actualHash)
        }
        if (expectedHash != actualHash) {
            throw HashMismatchException(file, actualHash = actualHash, expectedHash = expectedHash)
        }
    }
}
