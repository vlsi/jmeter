...
### General
  ...
  - [PR #6042](https://github.com/apache/jmeter/pull/6042)[Issue #6041](https://github.com/apache/jmeter/issues/6041)Fix compatibility with Maven's pom.xml parser by adding explicit versions for
